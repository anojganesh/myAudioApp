...
public class Song extends AudioContent implements Comparable<Song>// implement the Comparable interface
{
	...
	public void playAll(){ // duplicate of play for design purposes with audiobook
		setAudioFile(lyrics);
		super.play();
	...
	public boolean equals(Object other)
	{
		...
		if ( (this.composer.equals(other2.composer)) && (this.artist.equals(other2.artist)) && super.equals(other2) ){
			return true;
		}
		else{
		return false;
