...
abstract public class AudioContent
{
	...
	public AudioContent() //default constructor 
	{
		this.title = "";
		this.year = 0;
		this.id = "";
	...
	public AudioContent(String title, int year, String id, String type, String audioFile, int length) // constructor
	{
		this.title = title;
		this.year = year;
		this.id = id;
  ...
  // Play the content via the audio file
	...
	public void play2() // play without printing Info (part of playlist play in README.txt)
	{
	...
	public void playAll(){ // play all chapters (part of playlist play in README.txt)
		if (this.type == "AUDIOBOOK"){
			AudioBook this2 = (AudioBook)(this);
			this2.playAllChapters();
		}
		else{
			play();
		}
